...
class WindowsCommandException extends Exception {
    ...
    WindowsCommandException(String message, Throwable cause) {
        super(message, cause)
    }

    WindowsCommandException(String message) {
        super(message)
    }

    private WindowsCommandException(Throwable cause) {}
    private WindowsCommandException() {}
}
